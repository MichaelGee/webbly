    ...
    <div>
      <div className='card_container '>
        <div className='d-flex flex-row justify-content-center flex-wrap'>
          <div className='first_card shadow-lg'>
            <Card>
              <Card.Body className='card_body'>
                ...
                <Card.Text className='card_text'>
                  Check out free resourses & design tokens for your next
                  projects.
                </Card.Text>
              </Card.Body>
            </Card>
          </div>
          <div className='second_card shadow-lg'>
            <Card>
              <Card.Body className='card_body'>
                <div className='circle'>
          ...
          <div className='third_card shadow-lg'>
            <Card>
              <Card.Body className='card_body'>
                <div className='circle'>
